# Performance Engineering Profile

The team engineering standards (Clean Architecture, DRY, KISS, Clean Code) apply. The conventions below extend those standards with domain-specific guidance for performance analysis and optimization. Measure first, optimize second — never guess at bottlenecks.
